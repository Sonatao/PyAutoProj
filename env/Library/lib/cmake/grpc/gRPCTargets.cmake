...
set_target_properties(gRPC::grpc_authorization_provider PROPERTIES
  INTERFACE_COMPILE_FEATURES "cxx_std_17"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "protobuf::libupb;ws2_32;crypt32;re2::re2;ZLIB::ZLIB;absl::config;absl::no_destructor;absl::btree;absl::flat_hash_map;absl::flat_hash_set;absl::inlined_vector;absl::function_ref;absl::hash;absl::type_traits;absl::statusor;absl::string_view;absl::span;absl::utility;c-ares::cares;gRPC::gpr;gRPC::address_sorting"
)
